...
final class ServerConfig
{
    ...
    public $server_list_center_url;
    public $server_web_addr_url;
    public $account_server_center_url;
    ...
    public function init()
    {
        ...
        // server_list_center_url
        if (isset($ret['center']['server_list_center_url']) === false) {
            error_log('config /center/server_list_center_url not found');
            return false;
        }
        $this->server_list_center_url = $ret['center']['server_list_center_url'];

        // server_web_addr_url
        if (isset($ret['center']['server_web_addr_url']) === false) {
            error_log('config /center/server_web_addr_url not found');
            return false;
        }
        $this->server_web_addr_url = $ret['center']['server_web_addr_url'];

        // account_server_center_url
        if (isset($ret['center']['account_server_center_url']) === false) {
            error_log('config /center/account_server_center_url not found');
            return false;
        }
        $this->account_server_center_url = $ret['center']['account_server_center_url'];
