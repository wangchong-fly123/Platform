			...
			<div class="right-content">
				<div class="content-header">
					<ul class="hero-list clearfix">
						<?php foreach($all_hero as $temp){?>
							<li><a class="hover-link" href="<?=Url::toRoute(['site/hero','id'=>$temp->item_id])?>"><img src="<?=$temp->head?>" alt=""><span><?=$temp->hero_name?></span></a></li>
						<?php }?>
				...
				<div class="content-body">
					<div class="text-center">
						<img style="width:625px;height:280px;" class="hero-info-pic" src="<?=$hero->bg_image?>" alt="">
					</div>
					...
					<?=$hero->skill_intro?>
					<div class=" ">
						<!-- <img class="hero-info-pic" src="<?=$hero->attribute_image?>" alt=""> -->
					</div>
				</div>
