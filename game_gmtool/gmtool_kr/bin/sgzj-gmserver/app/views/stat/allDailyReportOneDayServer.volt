...
var get_all_daily_report_form = {
    ...
    elements: [
        { id: "datepicker:start_date",
          ...
          label: "날자", required: true, value: query_date },
...
var all_daily_report_list = {
    ...
    width: 1024,
    columns: [
        { id: "server_name", header: "서버", width: 300 },
        ...
        { id: "daily_pay_users", header: "일충전유저수",
          width: 120, sort: "int" },
        { id: "new_pay_users", header: "신규충전유저수",
          width: 120, sort: "int" },
        ...
        { id: "daily_new_user_pay_times", header: "일신규유저충전횟수",
          width: 150, sort: "int" },
        { id: "daily_new_user_pay_users", header: "일신규유저 충전 유저수",
          width: 160, sort: "int" },
        { id: "daily_new_user_pay_rate", header: "일신규유저 결제율", width: 130,
          sort: enjoymi.percentSortFunc("daily_new_user_pay_rate") },
        { id: "daily_avg_online_time", header: "일평균 사용시간(분)",
          width: 150, sort: "int" },
        { id: "daily_arpu", header: "ARPU",
          sort: "int" },
        { id: "daily_arppu", header: "ARPPU",
          sort: "int" },
        { id: "new_user_login_times", header: "신규유저 로그인 횟수",
          width: 130, sort: "int" },
        { id: "old_user_login_times", header: "기존유저 로그인 횟수",
          width: 130, sort: "int" },
    ],
