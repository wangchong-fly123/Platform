...
var transaction_list = {
    ...
    columns: [
        ...
        { id: "amount", header: "결제금액" },
        { id: "product_id", header: "상품ID" },
        { id: "product_count", header: "상품수량" },
        { id: "product_name", header: "상품명" },
        { id: "pay_time", header: "지불시간", width: 160 },
        { id: "order_type", header: "지불유형" },
        { id: "channel_number", header: "채널번호" },
        { id: "channel_order_id", header: "채널주문번호", width: 350 },
    ],
