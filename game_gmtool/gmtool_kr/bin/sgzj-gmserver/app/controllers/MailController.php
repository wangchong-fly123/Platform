...
final class MailController extends ControllerBase
{
    ...
    public function sendMailAction()
    {
        ...
        $this->opLog("[send email] server: $server_desc ".
                     "player ID: $player_id</br>".
                     "mail title: $mail_title</br>".
                     "mail text: $mail_content</br>".
                     "mail expiration time: $expired_minute</br>".
                     "mail reward:</br>$mail_awards_fmt");
    ...
    public function sendPlatformMailAction()
    {
        ...
        $mail_awards_fmt = preg_replace('/\]$/', '', $mail_awards_fmt);
        $mail_awards_fmt = preg_replace('/},/', '}</br>', $mail_awards_fmt);
        $this->opLog("[send mail(Follow the platform)] platform: $platform_id ".
                     "mail_title: $mail_title</br>".
                     "mail_text: $mail_content</br>".
                     "Mail expiration time: $expired_minute</br>".
                     "mail_reward:</br>$mail_awards_fmt");
    ...
    public function sendTimingMailAction()
    {
        ...
        $mail_awards_fmt = preg_replace('/\]$/', '', $mail_awards_fmt);
        $mail_awards_fmt = preg_replace('/},/', '}</br>', $mail_awards_fmt);
        $this->opLog("[send timing mail] server: $server_desc ".
                     "player ID: $players_id</br>".
                     "mail title: $mail_title</br>".
                     "mail context: $mail_content</br>".
                     "mail expired time: $expired_minute</br>".
                     "mail award:</br>$mail_awards_fmt".
                     "immediate send:$immediately_send".
                     "start send time:$start_send_time");
