...
final class ServerController extends ControllerBase
{
    ...
    public function addServerAction()
    {
        ...
        // op log
        $this->opLog("[new add server] platform_id: $platform_id ".
                     "server_ID: $server_id server description: $desc ".
                     "server address: $addr");
    ...
    public function updateServerAction()
    {
        ...
        // op log
        $this->opLog("[Edit the server] platform_id: $platform_id ".
                     "server_ID: $server_id server description: $desc ".
                     "server address: $addr");
    ...
    public function removeServerAction()
    {
        ...
        if ($server_model !== false) {
            ...
            $server_model->delete();
            // op log
            $this->opLog("[Remove the server] platform_id: $platform_id ".
                         "server_ID: $server_id server description: $desc");
        }
    ...
    public function loginSwitchAction()
    {
        ...
        $this->opLog("[Modify the server login settings] server: $server_desc ".
                     " Whether to close the login: $forbid_login");
